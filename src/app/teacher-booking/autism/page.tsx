...
const autismTeachers = [
  ...
  },
  {
    ...
    expertise: ['Cognitive Strategies', 'Strength-Based Learning', 'Transition Planning'],
    rating: 4.9,
    reviews: 112,
    hourlyRate: 75,
    availability: ['Mon', 'Wed', 'Fri', 'Sat'],
    image: '/images/teacher4.jpg',
    bio: 'Dr. Wilson focuses on identifying and leveraging cognitive strengths in autistic learners. He specializes in helping students transition between educational environments.',
  },
];
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-6 bg-purple-700 text-white">
        ...
        <p className="mt-2">
          Connect with teachers specialized in supporting autistic learners through personalized education approaches
        </p>
      </div>
