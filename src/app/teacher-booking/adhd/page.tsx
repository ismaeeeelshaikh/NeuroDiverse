...
const adhdTeachers = [
  ...
  {
    id: 4,
    name: 'Jason Rivera, M.S.',
    title: 'ADHD Academic Coach',
    expertise: ['Project Management', 'Homework Strategies', 'Technology Tools'],
    rating: 4.6,
    reviews: 76,
    hourlyRate: 55,
    availability: ['Wed', 'Thu', 'Sat', 'Sun'],
    image: '/images/teacher8.jpg',
    bio: 'Jason specializes in practical academic strategies for students with ADHD. He helps students leverage technology tools and develop project management skills to succeed in school and beyond.',
  },
];
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-6 bg-blue-700 text-white">
        ...
        <p className="mt-2">
          Connect with teachers specialized in supporting students with ADHD through effective learning strategies
        </p>
      </div>
