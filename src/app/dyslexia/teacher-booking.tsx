...
// Mock data for Dyslexia teachers
const dyslexiaTeachers = [
  {
    id: 1,
    name: 'Dr. James Wilson',
    title: 'Dyslexia Education Specialist',
    expertise: ['Phonological Awareness', 'Multisensory Learning', 'Reading Strategies'],
    rating: 4.9,
    reviews: 156,
    hourlyRate: 75,
    availability: ['Mon', 'Wed', 'Thu', 'Fri'],
    image: '/images/teacher8.jpg',
    bio: 'Dr. Wilson specializes in evidence-based approaches for dyslexia education. His methods focus on developing phonological awareness and multisensory learning techniques that help students build reading confidence.',
  },
  {
    id: 2,
    name: 'Priya Sharma, M.Ed.',
    title: 'Literacy Intervention Specialist',
    expertise: ['Structured Literacy', 'Orton-Gillingham Approach', 'Spelling Strategies'],
    rating: 4.8,
    reviews: 112,
    hourlyRate: 65,
    availability: ['Tue', 'Wed', 'Sat', 'Sun'],
    image: '/images/teacher9.jpg',
    bio: 'Priya is trained in the Orton-Gillingham approach and specializes in structured literacy interventions. Her teaching emphasizes systematic, explicit instruction that builds on students\' strengths.',
  },
  {
    id: 3,
    name: 'Dr. Robert Chen',
    title: 'Educational Neuropsychologist',
    expertise: ['Cognitive Processing', 'Assistive Technology', 'Executive Function Support'],
    rating: 4.7,
    reviews: 98,
    hourlyRate: 80,
    availability: ['Mon', 'Thu', 'Fri', 'Sun'],
    image: '/images/teacher10.jpg',
    bio: 'Dr. Chen combines neuropsychological insights with practical teaching strategies. He specializes in helping students with dyslexia leverage assistive technology and develop compensatory strategies.',
  },
];
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <button 
              ...
              className="bg-white text-purple-700 hover:bg-purple-100 px-6 py-2 rounded-lg font-medium transition"
            >
              Book a Teacher
            </button>
          </div>
          ...
          <div className="p-6 bg-purple-700 text-white">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="mt-2">
                  Connect with teachers specialized in supporting students with dyslexia
                </p>
              </div>
              <button 
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                ...
                <input
                  type="text"
                  id="expertise"
                  placeholder="e.g. Phonological Awareness, Structured Literacy"
